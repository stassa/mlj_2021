...
%
write_dataset:-
        configuration:mislabelling_probability(P)
...
%
write_dataset(L,P):-
        configuration:background_knowledge(BK)
        ,configuration:metarules(IDs)
        ,configuration:target_prefix_arity(T,A)
