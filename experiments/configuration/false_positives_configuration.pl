:-module(false_positives_configuration, [experiment_file/2
                                        ,example_clauses/1
...
% ================================================================================
% Note that coloured graph dataset configurations are characterised by
% their mislabelling_type/1 option.
